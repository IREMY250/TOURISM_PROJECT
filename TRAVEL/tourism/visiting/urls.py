...
from . views import signup,endpoints,login,logout,listusers,deleteusers,update_user,update_profile,create_activity,list_activity,user_activity,update_activity,delete_activity,Booking
